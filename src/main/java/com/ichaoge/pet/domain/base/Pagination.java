...
//			end = count;
    ...
    public String toString() {
        ...
        sb.append(",\"pageSizeTarget\":\"")
                .append(pageSizeTarget).append('\"');
        sb.append(",\"skipSizeTarget\":\"")
                .append(skipSizeTarget).append('\"');
        sb.append(",\"currentPageTarget\":\"")
                .append(currentPageTarget).append('\"');
        sb.append(",\"pageSize\":")
                .append(pageSize);
        sb.append(",\"pageCount\":")
                .append(pageCount);
